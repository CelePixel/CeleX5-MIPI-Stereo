...
private:
	...
	int*                     m_pFpnBuffer;
	//
	unsigned char*           m_pFrameBuffer1_ForUser;
	unsigned char*           m_pFrameBuffer2_ForUser;
	unsigned char*           m_pFrameBuffer3_ForUser;
	unsigned char*           m_pFrameBuffer4_ForUser;
	unsigned char*           m_pFrameBuffer5_ForUser;
	unsigned char*           m_pFrameBuffer6_ForUser;
	//
